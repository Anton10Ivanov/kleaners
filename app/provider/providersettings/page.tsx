  ...
  return (
    <div className="form-spacing-loose">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="notifications" className="form-spacing-relaxed">
          <NotificationSettings />
        </TabsContent>
        
        <TabsContent value="payment" className="form-spacing-relaxed">
          <PaymentSettings />
        </TabsContent>
        
        <TabsContent value="account" className="form-spacing-relaxed">
          <AccountSettings />
        </TabsContent>
      </Tabs>
    </div>
...
const NotificationSettings = () => {
  ...
  return (
    <Card>
      ...
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="form-spacing-loose">
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <RadioGroup
                      ...
                      className="flex flex-col component-spacing-xs"
                    >
                      <FormItem className="flex items-center space-x-3 form-spacing-none">
                        <FormControl>
  ...
  return (
    <div className="form-spacing-relaxed">
      ...
      <Card className="border-destructive">
        ...
        <CardContent className="form-spacing-tight">
          <p className="text-sm">
