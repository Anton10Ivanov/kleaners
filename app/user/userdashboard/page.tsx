...
const UserDashboard = () => {
  return (
    <div className="container mx-auto section-spacing-sm px-4 mt-8">
      <h1 className="text-2xl font-bold mb-6">My Dashboard</h1>
      
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow card-spacing-md">
          ...
          <button 
            ...
            className="mt-4 px-4 section-spacing-xs bg-primary text-white rounded-md text-sm"
          >
            Go to Bookings
          </button>
        </div>
