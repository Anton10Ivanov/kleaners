            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="form-spacing-loose">
                <div>
                  ...
                  <div className="form-spacing-normal">
                    {contactMethods.map((method, index) => 
                      <div key={index} onClick={method.action} className="flex items-center gap-4 card-spacing-sm rounded-lg hover:bg-muted cursor-pointer transition-colors">
                ...
                <div>
                  ...
                  <div className="form-spacing-tight card-spacing-sm rounded-lg bg-muted/50">
              ...
              {!showApplicationForm ? (
                ...
                <div className="max-w-4xl mx-auto">
                  <div className="text-center py-8">
                    <h3 className="text-xl font-semibold mb-4">Application Form Coming Soon</h3>
                    <p className="text-muted-foreground mb-4">
                      We're updating our application process. Please contact us directly for now.
                    </p>
