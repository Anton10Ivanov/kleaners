    ...
    <div className="min-h-screen pt-24 pb-12 px-4 md:px-6 max-w-6xl mx-auto">
      ...
      <div className="text-center mb-16">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <Badge variant="outline" className="text-sm px-4 section-spacing-xs">German Quality</Badge>
          <Badge variant="outline" className="text-sm px-4 section-spacing-xs">Fair Employment</Badge>
          <Badge variant="outline" className="text-sm px-4 section-spacing-xs">Social Impact</Badge>
          <Badge variant="outline" className="text-sm px-4 section-spacing-xs">Universal Access</Badge>
        </div>
      </div>
          ...
          <Card key={index} className="border-2 border-gray-200 dark:border-gray-700 hover:border-primary/30 transition-colors duration-300">
            <CardHeader className="pb-4">
              <div className="flex items-center space-x-4 mb-4">
                <div className="card-spacing-xs bg-gray-50 dark:bg-gray-800 rounded-lg">
                  {value.icon}
                </div>
      ...
      <Card className="bg-gradient-to-r from-primary/5 to-blue-50 dark:from-primary/10 dark:to-blue-950 border-primary/20 mb-16">
        <CardContent className="card-spacing-lg text-center">
            ...
            <Card key={index} className="text-center hover:shadow-lg transition-shadow duration-300">
              <CardContent className="card-spacing-md">
                <div className="flex justify-center mb-4">
                  <div className="card-spacing-xs bg-gray-50 dark:bg-gray-800 rounded-full">
                    {plan.icon}
                  </div>
                </div>
