...
export const BookingsFilter: React.FC<BookingsFilterProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 card-spacing-sm rounded-md border mb-4 form-spacing-relaxed">
          ...
          <div className="relative">
            ...
            {searchTerm && (
              <Button
                variant="ghost"
                size="sm"
                className="absolute right-1 top-1/2 transform -translate-y-1/2 h-6 w-6 card-spacing-none"
