...
export const EmptyBookingPool: React.FC<EmptyBookingPoolProps> = ({ isProviderView = false }) => {
  return (
    <Card>
      ...
      <CardContent>
        <div className="flex flex-col items-center justify-center text-center section-spacing-md">
          <div className="mx-auto bg-muted/50 rounded-full card-spacing-md mb-4">
