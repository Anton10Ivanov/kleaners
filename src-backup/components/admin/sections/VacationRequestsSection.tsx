...
export function VacationRequestsSection() {
  ...
  return (
    <Card>
      ...
      <CardContent>
        {isLoading ? (
          <div className="section-spacing-sm text-center text-muted-foreground">Loading vacation requests...</div>
        ) : vacationRequests.length === 0 ? (
          <div className="section-spacing-sm text-center text-muted-foreground">No vacation requests found</div>
        ) : (
          <Table>
            <TableHeader>
              <TableRow>
                      ...
                      {request.status === 'pending' && (
                        <div className="flex gap-2">
                          <Button 
                            size="sm" 
                            variant="outline" 
                            className="h-8 w-8 card-spacing-none text-green-500" 
                          ...
                          <Button 
                            size="sm" 
                            variant="outline" 
                            className="h-8 w-8 card-spacing-none text-red-500" 
