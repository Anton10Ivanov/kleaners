...
export const CompactTestimonials = () => {
  ...
  return (
    <section 
      className="section-spacing-sm bg-[#F2FCE2] dark:bg-gray-900"
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <Card className="h-full">
                    <CardContent className="card-spacing-xs h-full flex flex-col justify-between">
                      <div>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <Card className="w-40 md:w-44 h-28 md:h-32">
                    <CardContent className="card-spacing-xs h-full flex flex-col items-center justify-center text-center">
