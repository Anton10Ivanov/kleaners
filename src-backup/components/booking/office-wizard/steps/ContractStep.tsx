...
export const ContractStep: React.FC<ContractStepProps> = ({ selected, onSelect, previewQuote }) => {
  ...
  return (
    <div className="component-spacing-xl">
      ...
      <div className="flex items-center justify-center space-x-4 card-spacing-md bg-muted/30 rounded-xl">
      ...
      {/* Pricing Display */}
      {previewQuote && (
        <div className="bg-white border-2 border-primary/20 rounded-xl card-spacing-md">
