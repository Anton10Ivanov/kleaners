  ...
  return (
    <div className="fixed bottom-0 left-0 w-full z-50 bg-white border-t border-gray-200 shadow-lg dark:bg-gray-800 dark:border-gray-700">
      ...
      <Button
        ...
        className="w-full card-spacing-sm flex items-center justify-center h-auto rounded-none border-none dark:text-white"
      >
      ...
      <AnimatePresence>
        {isExpanded && (
          ...
          >
            <div className="card-spacing-sm form-spacing-normal max-h-64 overflow-y-auto">
              {/* Service Selection */}
              {selectedService && (
