    ...
    <div className="form-spacing-normal">
        ...
        {extraServices.map((extra) => {
          ...
          return (
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
              className={`
                card-spacing-xs cursor-pointer transition-all duration-200 border rounded-lg
                ${isSelected 
      ...
      {selectedExtras.length > 0 && (
        <motion.div
          ...
          className="card-spacing-xs bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800"
        >
