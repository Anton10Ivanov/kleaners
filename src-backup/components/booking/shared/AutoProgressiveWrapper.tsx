    ...
    <div className="form-spacing-loose">
      ...
      {isCompleted && (
        <motion.div
          ...
          className="flex items-center justify-center gap-2 text-secondary font-medium text-sm bg-secondary/10 border border-secondary/20 rounded-lg card-spacing-xs"
        >
