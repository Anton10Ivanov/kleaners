...
export const ServiceAreasList: React.FC<ServiceAreasListProps> = ({ 
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center section-spacing-sm px-2">
  ...
  if (serviceAreas.length === 0) {
    return (
      <div className="text-center section-spacing-sm px-4 border border-dashed rounded-xl bg-muted/20 mx-2">
        <div className="bg-primary/10 card-spacing-xs rounded-full w-14 h-14 mx-auto mb-3 flex items-center justify-center">
  ...
  return (
    <div className="form-spacing-normal px-2 sm:px-1">
        ...
        <AnimatePresence>
          {serviceAreas.map((area) => (
            <motion.div
              ...
              className="border rounded-lg card-spacing-xs bg-card hover:shadow-md transition-all flex flex-col justify-between"
            >
