      ...
      <div className="max-w-md mx-auto">
        <Card className="border-0 shadow-md">
          ...
          <CardContent className="form-spacing-relaxed">
            ...
            <div className="border rounded-md card-spacing-sm bg-muted/30">
            ...
            {!isSent ? (
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-md card-spacing-sm">
              ...
              <div className="bg-green-50 dark:bg-green-900/20 border border-green-100 dark:border-green-800 rounded-md card-spacing-sm">
                <div className="flex items-start">
          ...
          <CardFooter className="flex flex-col form-spacing-tight">
            {!isSent ? (
              <Button 
