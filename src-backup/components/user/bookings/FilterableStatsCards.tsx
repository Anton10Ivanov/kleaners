      ...
      >
        <CardContent className="pt-6">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="bg-blue-100 card-spacing-xs rounded-full mt-3 dark:bg-blue-950/30">
      ...
      >
        <CardContent className="pt-6">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="bg-green-100 card-spacing-xs rounded-full mt-3 dark:bg-green-950/30">
      ...
      >
        <CardContent className="pt-6">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="bg-red-100 card-spacing-xs rounded-full mt-3 dark:bg-red-950/30">
