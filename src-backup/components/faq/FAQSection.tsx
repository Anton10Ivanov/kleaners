...
export const FAQSection = memo(() => {
  ...
  return (
    <section className="section-spacing-xl md:py-24 bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
          ...
          {faqData.slice(0, 5).map((item, index) => (
            ...
            >
              <button
                ...
                className="w-full px-6 section-spacing-xs text-left flex items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200"
              >
        ...
        >
          <div className="bg-white dark:bg-gray-800 rounded-xl card-spacing-md border border-gray-200 dark:border-gray-700">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link to="/about/faq">
                <button className="bg-primary hover:bg-primary/90 text-white px-6 section-spacing-xs rounded-lg font-medium transition-colors duration-200">
                  View All FAQs
                </button>
              </Link>
              <Link to="/contact">
                <button className="bg-white hover:bg-gray-50 text-gray-900 px-6 section-spacing-xs rounded-lg font-medium border border-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-white dark:border-gray-600 transition-colors duration-200">
                  Get in Touch
                </button>
              </Link>
            </div>
