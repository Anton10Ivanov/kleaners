  ...
  return (
    <>
      ...
      {fileAttachments.length > 0 && (
        <div className="px-4 section-spacing-xs border-t grid grid-cols-1 sm:grid-cols-2 gap-2">
            ...
            <div key={index} className="relative">
              <div className="flex items-center p-2 rounded-md border bg-background">
                ...
                <Button 
                  variant="ghost" 
                  size="sm" 
                  className="h-7 w-7 card-spacing-none" 
      ...
      {/* Input area */}
      <div className="card-spacing-xs border-t flex items-center gap-2">
