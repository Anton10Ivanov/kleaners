...
export const TimeSlots = ({
  ...
  return (
    <div className="mt-6">
      ...
      {isLoading ? (
        <div className="flex justify-center items-center section-spacing-sm">
          <div className="h-8 w-8 border-4 border-primary border-t-transparent rounded-full animate-spin"></div>
        </div>
      ) : (
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 card-spacing-md">
          <TimeSlider
