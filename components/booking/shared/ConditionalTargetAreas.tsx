              ...
              <div className="form-spacing-relaxed">
                ...
                <AnimatePresence>
                  {cleaningType === 'partial' && (
                    ...
                    >
                      <div className="border rounded-lg card-spacing-sm bg-accent/20">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                          {specificAreas.map((area) => (
                            <div key={area.id} className="flex items-start space-x-3 card-spacing-xs rounded-lg border bg-background hover:bg-accent/50 transition-colors">
                              <Checkbox
                                id={area.id}
