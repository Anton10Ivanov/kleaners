    ...
    >
      {badges.map((badge, index) => (
        <motion.div
          ...
          className="flex flex-col items-center gap-2 bg-card/90 rounded-lg card-spacing-xs shadow-sm border border-border/50"
        >
          <div className="w-16 h-10 bg-muted rounded-md overflow-hidden">
            <Image src={badge.placeholder} alt={badge.alt}
