        ...
        >
          {trustMetrics.map((metric, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="text-center card-spacing-md bg-card rounded-xl border border-border"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {benefits.map((benefit, index) => (
            <motion.div
              ...
              transition={{ duration: 0.5, delay: index * 0.1 }}
              viewport={{ once: true }}
              className="group card-spacing-md bg-card rounded-xl border border-border hover:border-accent/50 transition-all duration-300 hover:shadow-lg"
            >
