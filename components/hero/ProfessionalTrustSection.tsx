...
export const ProfessionalTrustSection = memo(() => {
  ...
  return (
    <section className="section-spacing-2xl bg-muted/30">
          ...
          {trustFeatures.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                className="text-center card-spacing-lg bg-white dark:bg-gray-700 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-600"
              >
                <motion.div 
