  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-50 bg-white dark:bg-gray-800 z-50">
        ...
        {userRole === 'client' && (
          <DropdownMenuItem onClick={() => router.push('/client/bookings')}>
        ...
        {userRole === 'provider' && (
          <DropdownMenuItem onClick={() => router.push('/provider/assignments')}>
        ...
        <DropdownMenuItem 
          onClick={() => router.push(userRole === 'provider' ? '/provider/profile' : '/client/profile-settings')}
        >
