...
export const ScreenReaderNavigation: React.FC<ScreenReaderNavigationProps> = ({
  ...
  return (
    <nav 
      ...
      className="sr-only focus-within:not-sr-only focus-within:absolute focus-within:top-0 focus-within:left-0 focus-within:z-50 focus-within:bg-white focus-within:card-spacing-sm focus-within:shadow-lg"
    >
...
export const SkipToMainLink: React.FC = () => {
  return (
    <a
      href="#main-content"
      className="sr-only focus:not-sr-only focus:absolute focus:top-0 focus:left-0 focus:z-50 focus:bg-primary focus:text-primary-foreground focus:px-4 focus:section-spacing-xs focus:text-sm focus:font-medium"
    >
