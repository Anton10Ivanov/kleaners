...
const BookingDetailsCard = ({ booking, onClose }: BookingDetailsCardProps) => {
  ...
  return (
    <Box className="bg-white dark:bg-gray-800 rounded-lg shadow-sm h-full">
      <div className="card-spacing-sm flex items-center justify-between border-b border-gray-100 dark:border-gray-700">
      ...
      <div className="card-spacing-sm form-spacing-relaxed">
        {/* Status Badge */}
        ...
        {booking.special_instructions && (
          <div>
            ...
            <p className="mt-1 text-sm card-spacing-xs bg-muted rounded-md">{booking.special_instructions}</p>
          </div>
        )}

        {/* Price */}
        <div className="mt-4 card-spacing-xs bg-primary/10 rounded-md flex justify-between items-center">
