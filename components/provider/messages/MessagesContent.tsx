        ...
        <Box className="h-full flex items-center justify-center bg-background/50 backdrop-blur-sm border rounded-xl shadow-sm">
          <div className="text-center max-w-md mx-auto px-4">
            ...
            <button
              ...
              className="px-6 section-spacing-xs.5 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors duration-200 font-medium text-sm shadow-sm hover:shadow focus:outline-none focus:ring-2 focus:ring-primary/20"
            >
