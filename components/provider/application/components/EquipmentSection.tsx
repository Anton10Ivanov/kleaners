...
export const EquipmentSection: React.FC<EquipmentSectionProps> = ({ 
  ...
  return (
    <div className="form-spacing-normal">
      ...
      <div className="form-spacing-normal pt-1">
        <div className="card-spacing-sm bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-100 dark:border-gray-700">
