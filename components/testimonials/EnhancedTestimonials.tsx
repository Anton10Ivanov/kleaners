...
export const EnhancedTestimonials = memo(() => {
  return (
    <section className="section-spacing-xl md:py-24 bg-white dark:bg-gray-800 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white dark:bg-gray-700 rounded-xl shadow-lg border border-gray-100 dark:border-gray-600 card-spacing-md relative"
            >
        ...
        >
          <div className="bg-gray-50 dark:bg-gray-700 rounded-xl card-spacing-md inline-block">
