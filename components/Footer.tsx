...
>>>>>>> 72b3d18d84dbeda4e435b91c20b5a4c4fd882474:src/components/Footer.tsx
            ...
            <div className="bg-secondary border border-accent/30 rounded-xl card-spacing-sm mb-4 hover:shadow-lg transition-all duration-300">
              <div className="flex items-center gap-2 mb-3">
                <div className="p-1.5 bg-accent/20 rounded-lg">
                  <Star className="h-4 w-4 text-accent" />
                </div>
                <span className="text-sm font-bold text-accent">Business Partners</span>
                <Badge variant="secondary" className="bg-warning text-primary border-0 text-xs px-2 section-spacing-none.5">
                  Save 25%
                </Badge>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <Link href="/business-solutions" className="flex-1">
                  <Button 
                    size="sm" 
          ...
          <div>
            ...
            <ul className="form-spacing-tight text-sm md:text-base">
              {popularServices.map((service, index) => (
                <li key={index} className="flex items-center gap-2">
                  <Link href={service.href} className="text-dark-foreground opacity-80 hover:text-accent hover:opacity-100 transition-colors flex-1">
                    {service.title}
                  </Link>
                </li>
              ))}
              <li className="pt-2 border-t border-dark-foreground/20">
                <Link href="/services" className="text-accent hover:text-accent/80 transition-colors font-medium text-sm">
                  View All Services →
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="form-spacing-tight text-sm md:text-base">
              <li>
                <Link href="/about/values" className="text-dark-foreground opacity-80 hover:text-accent hover:opacity-100 transition-colors">
                  Company Values
                </Link>
              </li>
              <li>
                <Link href="/about/faq" className="text-dark-foreground opacity-80 hover:text-accent hover:opacity-100 transition-colors">
                  FAQ
                </Link>
              </li>
              <li>
                <Link href="/legal/terms" className="text-dark-foreground opacity-80 hover:text-accent hover:opacity-100 transition-colors">
                  Terms of Service
                </Link>
              </li>
              <li>
                <Link href="/legal/privacy" className="text-dark-foreground opacity-80 hover:text-accent hover:opacity-100 transition-colors">
                  Privacy Policy
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="form-spacing-tight text-sm md:text-base">
              <li>
                <Link href="/contact" className="text-dark-foreground opacity-80 hover:text-accent hover:opacity-100 transition-colors">
                  Get in Touch
                </Link>
              </li>
              <li>
                <Link href="/contact?tab=join" className="text-dark-foreground opacity-80 hover:text-accent hover:opacity-100 transition-colors">
                  Join Our Team
                </Link>
              </li>
            ...
            <div className="mt-4">
              ...
              <div className="component-spacing-xs text-xs text-dark-foreground opacity-80">
