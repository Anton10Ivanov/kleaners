...
export function DevTools() {
  ...
  return (
    <>
      ...
      {/* DevTools panel */}
      {isVisible && (
        <div className="fixed z-40 bottom-4 right-4 w-96 max-w-[90vw] bg-slate-900 rounded-lg shadow-lg text-white card-spacing-sm">
          <div className="flex justify-between items-center mb-3">
            <h3 className="font-medium">Dev Tools</h3>
            <X size={16} className="cursor-pointer" onClick={toggleVisibility} />
          </div>
          
          <div className="form-spacing-normal text-sm">
