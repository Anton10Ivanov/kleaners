...
const BusinessSolutions = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-primary/10 via-primary/5 to-transparent py-20 md:py-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {contractBenefits.map((benefit, index) => (
              <motion.div
                ...
                transition={{ duration: 0.6, delay: 0.1 * index }}
                className="flex items-start gap-4 p-6 bg-white dark:bg-gray-900 rounded-xl shadow-md"
              >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <Button 
              size="lg" 
              variant="secondary" 
              className="mt-8 text-lg px-8 py-4 bg-white text-primary hover:bg-gray-100"
            >
