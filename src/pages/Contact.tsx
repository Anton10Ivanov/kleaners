              ...
              <Card className="border-0 shadow-lg">
                ...
                <CardContent className="space-y-2">
                  {contactMethods.map((method, index) => <div key={index} className="group">
                      <a href={method.action} className="flex items-start gap-3 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                        ...
                        <div className="flex-1">
                          <h4 className="font-medium text-gray-900 dark:text-white mb-1">{method.title}</h4>
