                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="email" type="email" placeholder="Enter your email address" value={email} onChange={e => setEmail(e.target.value)} required className="h-12" />
                      </div>
                    </div>
                    
                    <div className="space-y-2">
                      <Label htmlFor="message">Message</Label>
                      <Textarea id="message" placeholder="Tell us how we can help you..." value={message} onChange={e => setMessage(e.target.value)} required className="min-h-[140px] resize-none" />
                    </div>
              ...
              <Card className="border-0 shadow-lg">
                ...
                <CardContent className="space-y-4">
                  {contactMethods.map((method, index) => <div key={index} className="group">
                      <a href={method.action} className="flex items-start gap-4 p-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
