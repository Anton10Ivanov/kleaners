...
export const regularCleaningData = {
  ...
  features: [
    {
      ...
      description: "Same high standards every visit with our trained cleaning professionals."
    },
    {
      icon: Clock,
      title: "Flexible Scheduling",
      description: "Weekly, bi-weekly, or monthly service that works with your lifestyle."
    },
    {
      icon: Shield,
      title: "Trusted & Insured",
      description: "Background-checked cleaners with full insurance coverage for peace of mind."
    },
    {
      icon: CheckCircle,
      title: "Satisfaction Guarantee",
      description: "Not happy? We'll return within 24 hours to make it right, free of charge."
    }
  ],
  startingPrice: "€45",
  ...
  testimonials: [
    ...
    },
    {
      name: "Sophie Chen",
      rating: 5,
      text: "The team is professional and trustworthy. I feel completely comfortable having them in my home.",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: "Not at all! Many clients prefer to have cleaning done while they're at work. We can arrange secure key access or use your preferred entry method."
    },
    {
