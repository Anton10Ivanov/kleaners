...
export const DeepCleaningSchema = z.object({
  ...
  targetAreas: z.array(z.enum(["bathroom", "kitchen", "living-room", "bedrooms", "balcony", "basement", "whole-place"])).min(1, "Please select at least one target area"),
  // Enhanced deep cleaning fields
  hazardousConditions: z.array(z.string()).optional(),
  contaminationLevel: z.string().optional(),
  airQualityConcerns: z.boolean().optional(),
  previousCleaningAttempts: z.string().optional(),
  specialEquipmentNeeded: z.array(z.string()).optional(),
  // Flexible scheduling
  flexibleScheduleNotes: z.string().optional(),
  pets: z.string().optional(),
