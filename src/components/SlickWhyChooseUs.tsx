...
const SlickWhyChooseUs = () => {
  ...
  return (
    <section id="why-choose-us-slider" className="py-16 md:py-24 bg-transparent">
          ...
          <Slider {...settings}>
            {whyChooseUsContent.map((item, index) => (
              <div key={index} className="px-4 py-6 focus:outline-none">
                <div 
                  className={`rounded-2xl overflow-hidden shadow-xl transition-all duration-700 transform ${item.color}`}
                >
