...
const MobileOptimizedServiceTemplate = ({ data, showTestimonials = false }: MobileOptimizedServiceTemplateProps) => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-6 px-4 bg-primary/5">
      ...
      {/* Sticky Bottom CTA */}
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 z-50 md:hidden">
