  ...
  return <section id="about" className="py-[60px] bg-transparent rounded-none my-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 bg-transparent">
          {advantages.map(advantage => <div key={advantage.title} className="group p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 dark:border-gray-700 py-[5px] rounded-2xl bg-inherit">
