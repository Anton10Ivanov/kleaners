        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-1 gap-4 mb-8">
              {highlights.map((highlight, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="flex items-center gap-4 p-4 bg-white/70 dark:bg-gray-800/70 rounded-lg border border-gray-200/50 dark:border-gray-700/50"
                >
          ...
          >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="absolute -top-4 -right-4 bg-primary text-white p-4 rounded-xl shadow-lg"
            >
