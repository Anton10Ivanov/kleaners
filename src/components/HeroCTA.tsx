      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="w-full md:w-1/3 flex justify-center md:justify-end">
            <Link to="/booking">
              <Button className="text-white rounded-xl h-12 px-6 shadow-[0_8px_15px_rgba(126,188,230,0.2)] hover:shadow-[0_8px_15px_rgba(126,188,230,0.4)] bg-orange-600 hover:bg-orange-500 text-lg font-normal">
