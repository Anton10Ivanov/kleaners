  ...
  if (isMobile) {
    return (
      <div className="space-y-4">
        {Object.entries(comparisonData).map(([category, features], categoryIndex) => (
          <motion.div
            key={category}
            ...
            viewport={{ once: true }}
            className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden"
          >
                ...
                <div key={feature.feature} className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    <div className="flex items-start space-x-2 p-2 bg-green-50 dark:bg-green-900/20 rounded border border-green-200 dark:border-green-800">
                      ...
                      <div>
                        <div className="text-xs font-medium text-green-800 dark:text-green-300 mb-0.5">Kleaners.de</div>
                        <div className="text-xs text-green-700 dark:text-green-200">{feature.ourBenefit}</div>
                      </div>
                    </div>
                    <div className="flex items-start space-x-2 p-2 bg-red-50 dark:bg-red-900/20 rounded border border-red-200 dark:border-red-800">
                      ...
                      <div>
                        <div className="text-xs font-medium text-red-800 dark:text-red-300 mb-0.5">Typical Companies</div>
                        <div className="text-xs text-red-700 dark:text-red-200">{feature.theirLimitation}</div>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div className="space-y-6">
      {Object.entries(comparisonData).map(([category, features], categoryIndex) => (
        <motion.div
          ...
          transition={{ duration: 0.5, delay: categoryIndex * 0.1 }}
          viewport={{ once: true }}
          className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden shadow-sm"
        >
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-700">
                  <th className="text-left py-3 px-4 font-medium text-gray-900 dark:text-white w-1/3">
                    Feature
                  </th>
                  <th className="text-center py-3 px-4 font-medium text-green-700 dark:text-green-400 w-1/3">
                    Kleaners.de
                  </th>
                  <th className="text-center py-3 px-4 font-medium text-red-700 dark:text-red-400 w-1/3">
                    Typical Companies
                  </th>
                </tr>
              </thead>
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-center align-top">
                      <div className="flex flex-col items-center space-y-1">
                        ...
                        <div className="text-xs text-green-700 dark:text-green-300 text-center max-w-xs">
                          {feature.ourBenefit}
                        </div>
                      </div>
                    </td>
                    <td className="py-3 px-4 text-center align-top">
                      <div className="flex flex-col items-center space-y-1">
                        ...
                        <div className="text-xs text-red-700 dark:text-red-300 text-center max-w-xs">
