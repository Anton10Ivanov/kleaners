...
const Hero = ({
  ...
  return <div className="relative min-h-[85vh] flex items-center justify-center py-12 bg-gradient-to-b from-[#FEF7CD] to-white dark:to-transparent">
      <div className="relative z-10 max-w-7xl mx-auto w-full px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          <div className="text-left space-y-8">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight text-gray-900 dark:text-white">Expert Cleaning Services</h1>
            ...
            <div className="bg-white dark:bg-surface p-8 md:p-10 shadow-xl rounded-2xl max-w-xl mx-auto border border-gray-100 dark:border-gray-800">
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Input type="text" placeholder="Enter postal code" value={postalCode} onChange={e => setPostalCode(e.target.value)} className="flex-1 bg-white dark:bg-gray-800 font-medium h-12" />
                  <Button onClick={handleNext} className="bg-primary hover:bg-primary/90 text-white w-full sm:w-auto shadow-lg hover:shadow-xl transition-all font-semibold h-12 px-8">
