    ...
    <section className="py-16 md:py-24 bg-gradient-to-br from-background to-muted/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {TRUST_METRICS.map((metric, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group text-center p-6 bg-card/60 backdrop-blur-sm rounded-2xl border border-border/50 hover:border-primary/20 hover:bg-card/80 transition-all duration-300"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {KEY_BENEFITS.map((benefit, index) => (
            <motion.div
              ...
              transition={{ duration: 0.5, delay: index * 0.1 }}
              viewport={{ once: true }}
              className={`group p-6 bg-card/60 backdrop-blur-sm rounded-2xl border border-border/50 hover:border-primary/20 hover:bg-card/80 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="text-center mb-12 p-8 bg-primary/5 rounded-2xl border border-primary/10"
        >
        ...
        >
          {SECURITY_BADGES.map((badge, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="text-center p-4 bg-card/40 backdrop-blur-sm rounded-xl border border-border/30 hover:border-primary/20 hover:bg-card/60 transition-all duration-200"
            >
