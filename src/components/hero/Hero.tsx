...
export const Hero = memo(({
  ...
  return (
    <section className="relative min-h-[90vh] md:min-h-[85vh] flex items-center justify-center pt-24 pb-12 bg-[#0f172a] text-white transition-colors duration-300 overflow-hidden">
