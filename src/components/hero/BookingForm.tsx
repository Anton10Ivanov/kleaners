    ...
    <div className="backdrop-blur-xl p-6 border-2 border-[#08B]/30 transition-all hover:shadow-[0_15px_50px_-12px_rgba(126,188,230,0.3)] duration-300 bg-white/95 rounded-2xl">
      <div className="flex flex-col sm:flex-row gap-4 items-center">
        ...
        <div className="w-full sm:w-1/4 mt-auto">
          <Button 
            onClick={handleNextStep} 
            className="bg-primary hover:bg-primary/90 w-full shadow-[0_8px_30px_rgba(126,188,230,0.3)] hover:shadow-[0_8px_30px_rgba(126,188,230,0.5)] transition-all font-bold h-14 px-8 rounded-xl text-center text-white border-2 border-[#08B]"
          >
