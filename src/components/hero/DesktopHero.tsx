  ...
  return <div className="w-full space-y-6">
      ...
      duration: 0.6
        ...
        delay: 0.3
          ...
          {benefits.map((benefit, index) => <div key={index} className="flex items-center gap-3 justify-center">
      ...
      delay: 0.4
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-5 gap-3 max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            <Input type="text" placeholder="Enter your city or postal code" value={postalCode} onChange={e => setPostalCode(e.target.value)} className="pl-12 rounded-lg border-gray-300 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-colors hover:border-gray-400" required />
          </div>
          ...
          <div className="relative">
            ...
            <Input type="date" placeholder="Select date" className="pl-12 rounded-lg border-gray-300 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-colors hover:border-gray-400" min={new Date().toISOString().split('T')[0]} />
          </div>
          ...
          {/* CTA Button */}
          <Button type="submit" className="px-8 bg-orange-600 hover:bg-orange-700 text-white font-semibold rounded-lg flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">
