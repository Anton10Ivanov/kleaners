      ...
      <div className="flex flex-col space-y-6 w-full md:w-[80%] order-2 md:order-1 px-0 mx-0">
        ...
        >
          ...
          <motion.h1 
            ...
            className="text-4xl sm:text-5xl leading-tight mb-5 text-left font-extrabold text-[#1c1c1c] lg:text-6xl"
          >
          ...
          <p className="text-lg md:text-xl max-w-md text-slate-600 mb-8">
            Professional Kleaners, transparent conditions, fair pricing and guaranteed satisfaction.
          </p>
        </motion.div>
        ...
        {/* Social proof positioned below the form with more space */}
