...
export const HeroForm = memo(({
  ...
  return <motion.div initial={{
    ...
    delay: 0.7,
    ease: "easeOut"
  }} className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-0 my-0 max-w-sm mt-0 backdrop-blur-sm shadow-2xl border border-white/20 p-10 px-[19px] bg-transparent rounded-none py-0">
