      ...
      <div className="relative overflow-hidden">
        ...
        <CalendarUI
          ...
          classNames={{
            ...
            month: "space-y-4",
            caption: "flex justify-center pt-1 relative items-center text-primary dark:text-dark-primary",
            ...
            day_selected: "bg-primary dark:bg-dark-primary text-white hover:bg-primary hover:text-white dark:hover:bg-dark-primary",
            day_today: "bg-accent/20 dark:bg-dark-surface text-primary dark:text-dark-primary",
            day_outside: "text-gray-400 dark:text-gray-600 opacity-50",
            day_disabled: "text-gray-400 dark:text-gray-600 opacity-50 hover:bg-transparent",
