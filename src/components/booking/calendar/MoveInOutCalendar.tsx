...
const MoveInOutCalendar = ({ form }: MoveInOutCalendarProps) => {
  ...
  return (
    <div className="bg-white dark:bg-dark-background p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800">
      <h3 className="text-xl font-semibold mb-6 text-gray-900 dark:text-white">
        Select Days for Move In/Out Cleaning
      </h3>
          ...
          <div className="flex flex-wrap gap-2">
            {selectedDates.map(date => (
              <span 
                ...
                className="text-sm bg-white dark:bg-gray-700 px-3 py-1 rounded-full"
              >
